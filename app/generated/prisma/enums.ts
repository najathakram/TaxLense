...
export const PipelineRunKind = {
  ...
  GENERATE_AI_PROPOSALS: 'GENERATE_AI_PROPOSALS',
  CPA_AGENT: 'CPA_AGENT',
  EXTRACT_REPASS: 'EXTRACT_REPASS',
  PRE_CLEANUP: 'PRE_CLEANUP',
  CPA_AUDIT: 'CPA_AUDIT',
  COHAN_SWEEP: 'COHAN_SWEEP',
  SUBSTANTIATION_QUEUE: 'SUBSTANTIATION_QUEUE',
  FINDINGS_APPLY: 'FINDINGS_APPLY',
  RELOCK_VERIFY: 'RELOCK_VERIFY'
} as const
