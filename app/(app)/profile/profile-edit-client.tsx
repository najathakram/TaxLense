    ...
    <div className="space-y-4">
      ...
      <Section title="Basics" step={1}>
        <dl className="grid grid-cols-2 gap-x-4 gap-y-1 text-sm">
          ...
          <dt className="text-muted-foreground">Entity type</dt><dd>{data.entityType === "SOLE_PROP" ? "Sole Proprietor" : data.entityType === "LLC_SINGLE" ? "Single-Member LLC" : data.entityType === "S_CORP" ? "S-Corporation" : data.entityType === "LLC_MULTI" ? "Multi-Member LLC" : data.entityType === "C_CORP" ? "C-Corporation" : (data.entityType ?? "—")}</dd>
